document.addEventListener("DOMContentLoaded", function () {
    ...
    require([
        ...
        function onMove2(event) {
            ...
            console.log(vertices2 + verticesTrajet);
        ...
        function queryLayerViewAgeStats1(buffer1) {
            ...
            let femaleAgeData = ['nb de point de depard', 0],
                maleAgeData = ['nb de point d arriver', 0];
            ...
            const query = BDDtrajet.layer.createQuery();
    ...
    const anim0 = gsap.from("#head", { duration: 6, opacity: 0, x: "random(3000,4000)", y: "random(1500,2500)", scale: 0.3, stagger: 0.5, paused: true });
    const anim1 = gsap.from("#nav", { duration: 4, opacity: 0, x: "-1000", stagger: 0.5, paused: true });
